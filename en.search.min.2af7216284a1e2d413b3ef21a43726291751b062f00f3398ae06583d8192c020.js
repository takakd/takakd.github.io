...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.006763815dcfb23ca9f046e7545782faf3a1e68ca30b0a6f46d244846e07876e.js',function(){input.required=false;search();});}
